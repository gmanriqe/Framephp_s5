    ...
    <div id="wrap" >
       ...
       <div id="left" >
            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel ">
                    <a href="<?php echo BASE_URL?>index/panel" >
                        <i class="icon-table"></i> Panel Principal
                    </a>                   
                </li>
                
                <li class="panel ">
                    <a href="<?php echo BASE_URL?>usuario/listarUsuario" >
                        <i class="icon-table"></i> Lista Usuario
                    </a>                   
                </li>
                
                
                <li class="panel ">
                    <a href="<?php echo BASE_URL?>usuario/producto" >
                        <i class="icon-table"></i> Lista Producto
                    </a>                   
                </li>
